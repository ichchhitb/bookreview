	...
	<center>
		<form action="Insert" method="post">
			<table border="0">
				...
				<tr>
					<td>Summary:<span id="asterisk">*</span></td>
					<td><input type="text" name="summary"
						placeholder="Book Summary" required></td>
				</tr>
				<tr>
					<td>Image URL<span id="asterisk">*</span>:</td>
